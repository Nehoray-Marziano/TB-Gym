                    ...
                    <AnimatePresence mode="wait">
                        {!isLoginOpen ? (
                            ...
                            >
                                ...
                                <motion.button
                                    whileHover={{ scale: 1.02, backgroundColor: "#000000", color: "#ffffff", borderColor: "#333" }}
                                    whileTap={{ scale: 0.98 }}
                                    className="flex items-center gap-3 bg-black/50 border border-neutral-700 text-white font-bold py-4 px-6 rounded-2xl transition-colors min-w-[160px] justify-center grayscale opacity-80"
                                >
